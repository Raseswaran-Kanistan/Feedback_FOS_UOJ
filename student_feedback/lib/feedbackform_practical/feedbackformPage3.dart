...
import 'feedbackformPage4.dart'; // Import the Page4 widget

class practicalPage3 extends StatefulWidget {
  final Map<String, dynamic>? formData;

  practicalPage3({this.formData});

  @override
  _Page3State createState() => _Page3State();
}

class _Page3State extends State<practicalPage3>
  ...
  void _validateAndProceed() {
    ...
    if (conduciveEnvironment == null ||
      ...
      // GoRouter.of(context).go(Routers.feedbackformPage4.path);
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => practicalPage4(
        ...
        leading: IconButton(
          onPressed: () {
            ...
            if (canPop) {
              ...
              GoRouter.of(context)
                  .go('/practicalPage2'); // Replace with your desired route
            }
          },
          icon: const Icon(
            CupertinoIcons.back,
