...
import 'feedbackformPage6.dart';

class practicalPage5 extends StatefulWidget {
  final Map<String, dynamic>? formData; // Receive formData from previous page

  practicalPage5({required this.formData});

  @override
  _Page5State createState() => _Page5State();
}

class _Page5State extends State<practicalPage5>
  ...
  void _validateAndProceed() {
    ...
    if (stimulateInterest == null ||
      ...
      // GoRouter.of(context).go(Routers.feedbackformPage6.path);
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => practicalPage6(
        ...
        leading: IconButton(
          onPressed: () {
            ...
            if (canPop) {
              ...
              GoRouter.of(context)
                  .go('/practicalPage4'); // Replace with your desired route
            }
          },
          icon: const Icon(
            CupertinoIcons.back,
            ...
            children: <Widget>[
              Expanded(
                child: ListView(
                  children: <Widget>[
                    Text(
                      'Quality of Teaching/Demonstration',
                      style: TextStyle(
                          fontSize: 20,
                    ...
                    _buildDropdownQuestion(
                      'The method chosen always stimulates interest in learning.',
                      stimulateInterest,
                      (String? newValue) {
                        setState(() {
                    ...
                    _buildDropdownQuestion(
                      'The lecturer/demonstrator maintained an appropriate pace for my understanding and note-taking.',
                      appropriatePace,
                      (String? newValue) {
                        setState(() {
                    ...
                    _buildDropdownQuestion(
                      'Reasonable time is given for clarification.',
                      reasonableTime,
                      (String? newValue) {
                        setState(() {
