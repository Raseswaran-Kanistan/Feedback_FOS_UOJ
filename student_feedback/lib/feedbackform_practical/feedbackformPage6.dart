...
class practicalPage6 extends StatefulWidget {
  final Map<String, dynamic>? formData; // Receive formData from previous pages

  practicalPage6({required this.formData});

  @override
  _Page6State createState() => _Page6State();
}

class _Page6State extends State<practicalPage6>
  ...
  void _validateAndProceed() {
    ...
    if (assessmentSatisfaction == null ||
      ...
      };
      {
        ...
        GoRouter.of(context).go(Routers.studashboard.path);
      }
    }
  }
        ...
        leading: IconButton(
          onPressed: () {
            ...
            if (canPop) {
              ...
              GoRouter.of(context)
                  .go('/practicalPage5'); // Replace with your desired route
            }
          },
          icon: const Icon(
            CupertinoIcons.back,
