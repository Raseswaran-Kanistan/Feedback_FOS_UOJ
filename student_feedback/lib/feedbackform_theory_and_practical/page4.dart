...
class BothFeedbackPageFour extends StatefulWidget {
  final Map<String, dynamic>? formData; // Receive formData from previous page

  BothFeedbackPageFour({required this.formData});

  @override
  _BothFeedbackPageFourState createState() => _BothFeedbackPageFourState();
}

class _BothFeedbackPageFourState extends State<BothFeedbackPageFour>
  ...
  void _validateAndProceed() {
    ...
    if (studentCentered == null ||
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => BothFeedbackPageFive(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    _buildDropdownQuestion(
                      'Course design and teaching methods are student centered.',
                      studentCentered,
                      (String? newValue) {
                        setState(() {
                    ...
                    _buildDropdownQuestion(
                      'Appropriate teaching methods are used to have proper balance between lecture and practical.',
