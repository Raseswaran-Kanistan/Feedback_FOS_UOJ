...
class BothFeedbackPageFive extends StatefulWidget {
  final Map<String, dynamic>? formData; // Receive formData from previous page

  BothFeedbackPageFive({required this.formData});

  @override
  _BothFeedbackPageFiveState createState() => _BothFeedbackPageFiveState();
}

class _BothFeedbackPageFiveState extends State<BothFeedbackPageFive>
  ...
  void _validateAndProceed() {
    ...
    if (stimulateInterest == null ||
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => BothFeedbackPageSix(
